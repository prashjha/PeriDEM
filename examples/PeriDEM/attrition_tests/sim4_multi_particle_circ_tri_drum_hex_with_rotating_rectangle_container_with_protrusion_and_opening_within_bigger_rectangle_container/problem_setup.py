...
def create_input_file(inp_dir, pp_tag):
  ...
  wall_rot_working_rect_relative_corner_point_2 = [wall_rot_max_dist_from_rot_center, wall_rot_max_dist_from_rot_center, 0.]

  wall_rot_working_rect_corner_point_1 = [wall_rotation_center[0] + wall_rot_working_rect_relative_corner_point_1[0], wall_rotation_center[1] + wall_rot_working_rect_relative_corner_point_1[1], wall_rotation_center[2] + wall_rot_working_rect_relative_corner_point_1[2]]
  
  wall_rot_working_rect_corner_point_2 = [wall_rotation_center[0] + wall_rot_working_rect_relative_corner_point_2[0], wall_rotation_center[1] + wall_rot_working_rect_relative_corner_point_2[1], wall_rotation_center[2] + wall_rot_working_rect_relative_corner_point_2[2]]

  # define geometric parameters

  # base annulus rectangle (this will encapsulate the rotation rectangle)
  # left-bottom corner
  base_rect_inner_corner_point_1 = [wall_rot_working_rect_corner_point_1[0] - 0.2*L, wall_rot_working_rect_corner_point_1[1] - 0.2*L, wall_rot_working_rect_corner_point_1[2]]
  # right-top corner
  ...
  base_rect_outr_pts = get_ref_rect_points(get_center(base_rect_inner_corner_point_1, base_rect_inner_corner_point_1), base_rect_inner_corner_point_2[0] - base_rect_inner_corner_point_1[0] + 2*base_rect_x_thickness, base_rect_inner_corner_point_2[1] - base_rect_inner_corner_point_1[1] + 2*base_rect_y_thickness)

  base_rect_peridem_params = serialize_matrix_list([base_rect_outr_pts[0], base_rect_outr_pts[2], base_rect_innr_pts[0], base_rect_innr_pts[2]])

  # container geometry (L, W, center)
  container_center = get_center(base_rect_inner_corner_point_1, base_rect_inner_corner_point_1)
  contain_rect = [base_rect_inner_corner_point_2[0] - base_rect_inner_corner_point_1[0] + 2*base_rect_x_thickness, base_rect_inner_corner_point_2[1] - base_rect_inner_corner_point_1[1] + 2*base_rect_y_thickness, container_center[0], container_center[1], container_center[2]]
  ...
  zones_mesh_fnames = ["mesh_cir_small", "mesh_tri_small", "mesh_drum2d_small", "mesh_hex_small", "mesh_cir_large", "mesh_tri_large", "mesh_drum2d_large", "mesh_hex_large", "mesh_rect_protrsn_opening_container", "mesh_rect_container"]
  ...
  generate_rect_container_gmsh_input(inp_dir, zones_mesh_fnames[9], base_rect_inner_corner_point_1, base_rect_inner_corner_point_2, base_rect_x_thickness, base_rect_y_thickness, mesh_size, pp_tag)
  ...
  inpf.write("    Parameters: " + print_dbl_list(base_rect_peridem_params))
  inpf.write("    All_Dofs_Constrained: true\n")
  inpf.write("    Create_Particle_Using_ParticleZone_GeomObject: true\n")
