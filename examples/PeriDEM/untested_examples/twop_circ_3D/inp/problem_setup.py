...
def create_input_file(inp_dir, pp_tag):
  ...
  #
  inpf.write("Particle:\n")
  inpf.write("  Test_Name: two_particle_3D\n")
  inpf.write("  Zone_1:\n")
  ...
  ## zone 1
  inpf.write("  Zone_1:\n")
  inpf.write("    File: mesh_sphere_1_" + str(pp_tag) + ".msh \n")

  ## zone 2
  inpf.write("  Zone_2:\n")
  inpf.write("    File: mesh_sphere_2_" + str(pp_tag) + ".msh \n")
  ...
  p_mesh_fname = ['mesh_sphere_1', 'mesh_sphere_2']
  # generate particle .geo file (large)
  generate_particle_gmsh_input(inp_dir, 'mesh_sphere_1', center, R1, mesh_size, pp_tag)
  generate_particle_gmsh_input(inp_dir, 'mesh_sphere_2', center, R2, mesh_size, pp_tag)
