...
def create_input_file(inp_dir, pp_tag):
  ...
  # moving wall
  # desired_y_begin = a - t*0.06 -> a = desired_y_begin + t*0.06
  # mw_dy1 = dy1
  mw_dy1 = 0.0346
  mw_rect = [dx0-wpd, mw_dy1+wpd, dz0, dx1+wpd, mw_dy1+rwp, dz0]

  # maximum distance to stop the simulation
  max_dist_check = 20.*dx1

  ## time 
  final_time = 0.15  # 0.06 from before + new time interval
  num_steps = 1500000
  # final_time = 0.00002
  # num_steps = 1
  num_outputs = 1000
  ...
  #
  inpf.write("Restart:\n")
  inpf.write("  File: output_400\n")
  inpf.write("  Step: 600000\n")
  ...
  generate_cir_particle_gmsh_input(inp_dir, 'mesh_particle_1', center, R1, mesh_size, pp_tag)
