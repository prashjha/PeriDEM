...
f_p_1_mesh="mesh_particle_1$f_suf"
gmsh "$f_p_1_mesh.geo" -2 &> /dev/null
gmsh "$f_p_1_mesh.geo" -2 -o "$f_p_1_mesh.vtk" &> /dev/null

f_p_2_mesh="mesh_particle_2$f_suf"
gmsh "$f_p_2_mesh.geo" -2 &> /dev/null
gmsh "$f_p_2_mesh.geo" -2 -o "$f_p_2_mesh.vtk"  &> /dev/null

f_mw_mesh="mesh_moving_wall$f_suf"
gmsh "$f_mw_mesh.geo" -2  &> /dev/null
gmsh "$f_mw_mesh.geo" -2 -o "$f_mw_mesh.vtk"  &> /dev/null

f_rw_mesh="mesh_rigid_wall$f_suf"
gmsh "$f_rw_mesh.geo" -2  &> /dev/null
gmsh "$f_rw_mesh.geo" -2 -o "$f_rw_mesh.vtk"  &> /dev/null
