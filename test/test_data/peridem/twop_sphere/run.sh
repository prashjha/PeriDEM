...
gmsh "$f_p_1_mesh.geo" -3 &> /dev/null
gmsh "$f_p_1_mesh.geo" -3 -o "$f_p_1_mesh.vtk" &> /dev/null

f_p_2_mesh="mesh_cir_2$f_suf"
gmsh "$f_p_2_mesh.geo" -3 &> /dev/null
gmsh "$f_p_2_mesh.geo" -3 -o "$f_p_2_mesh.vtk"  &> /dev/null
