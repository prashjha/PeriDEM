...
#   Self_Contact: reference_gap
#   Wall_Contact: analytical_plane
#   Bond_Break:   absolute_stretch
#
# Normal contact spring is always force density ∝ corrected neighbor volume Vj
# (there is no Pair_Law selector). The velocity update is v += (dt/rho)*f.
#
